...
# Hier neuer bear code
    ...
    for coin in volume:
        ...
        buybull = (coin not in coins_bought and price_change >= (-0.9) and float(lastpriceb) >= last_sell_static and currentprice >= last_sell * 1.0012 and currentprice >= hist * 1.0012) # hier statt 0,0007 auf 0,0012
        ...
        elif buybull or buyneutral  or buybear :
            print(f"{txcolors.BUY}Preparing to buy {volume[coin]} {coin}{txcolors.DEFAULT}")
...
def sell_coins():
    ...
    for coin in list(coins_bought):
        ...
        level4 = (LastPrice >= BuyPrice * 1.0026 and LastPrice <= maxpricea * 0.9997)
        level5 = (LastPrice >= BuyPrice * 1.0030 and LastPrice <= maxpricea * 0.9996)
        level6 = (LastPrice >= BuyPrice * 1.0034 and LastPrice <= maxpricea * 0.9996)
        level7 = (LastPrice >= BuyPrice * 1.0038 and LastPrice <= maxpricea * 0.9995)
