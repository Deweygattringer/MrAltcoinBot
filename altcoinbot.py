...
def maxprice():
    ...
    if currentprice > maxpricec *1.005:
...
def buy():
    ...
    for coin in volume:
        ...
        if coin not in coins_bought and float(lastpriceb) * 1.03 <= maxpricea :
...
def sell_coins():
    ...
    for coin in list(coins_bought):
        ...
        if LastPrice <= (maxpricea * 0.995) and LastPrice > (BuyPrice * 1.015):
