...
def sell_coins():
    ...
    for coin in list(coins_bought):
        ...
        if (LastPrice <= (maxpricea * 0.9997) and LastPrice >= (BuyPrice * 1.0016)) or (LastPrice <= BuyPrice * 0.988 ):
