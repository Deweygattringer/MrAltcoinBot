...
# Add buy and sell columns
    ...
    print(f'{txcolors.BLUE}current : {currentprice}      avg : {avg}        {txcolors.DEFAULT} \n  ') 
    ...
    for coin in volume:
        ...
        print(f'Buysignal = positio {position} is 1.0 and signal{signal} is 1.0 and avg{avg} > ussma{ussma} and ussma{ussma} > ssma{ssma} and curr{currentprice} > avg{avg} and ussma{ussma} > oldussma{oldussma} and ssma {ssma} > oldssma{oldssma}: {buysignal}\n ')
        
        print(f'Buysignal2 = positionold {positionold} is 0.0 and signalold {signalold} is 1.0 and signal{signal} is 1.0 and avg{avg} > ussma{ussma} and ussma{ussma} > ssma{ssma} and curr{currentprice} > avg{avg} and ussma{ussma} > oldussma{oldussma} and ssma {ssma} > oldssma{oldssma}: {buysignal2}\n ')
        ...
        if buysignal:
            ...
            # run the else block if the position has been placed and return order info
                ...
                while orders[coin] == []:
                    ...
                    #    Log trade
                    if LOG_TRADES:
                        write_log(f"lowbot just bought position=1: {volume[coin]} {coin} @ {last_price[coin]['price']}")
            ...
            # run the else block if the position has been placed and return order info
                ...
                while orders[coin] == []:
                    ...
                    #    Log trade
                    if LOG_TRADES:
                        write_log(f"lowbot just bought position 0, signal 1: {volume[coin]} {coin} @ {last_price[coin]['price']}")
